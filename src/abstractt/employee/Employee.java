package abstractt.employee;
//super
abstract class Employ{
    private String name;
    private double base_salary;

    public Employ(String name, double base_salary){
...
public class Employee {
    public static void main(String[] args) {
        Employ manage = new Manager("Mark", 750, 240, 20);
        Employ program = new Programmer("Tony", 800, 200, 20,26, 40);
        System.out.println("-------------------------------------");
        manage.display_info();
