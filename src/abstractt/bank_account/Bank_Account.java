package abstractt.bank_account;
abstract class Bank{
    private final String account_number;
    private double balance;

    public Bank(String account_number, double balance){
...
public class Bank_Account {
    public static void main(String[] args) {
        Bank s = new Savings_Account("6O87E", 45000);
        Bank c = new Current_Account("7T04A", 100000);
        s.deposit(45000);
        s.withdraw(10000);
